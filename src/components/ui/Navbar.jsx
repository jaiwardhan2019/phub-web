...
import messageItem3 from '../../assets/img/messages-3.jpg';
          ...
          <li className="nav-item dropdown">
            ...
            <ul className="dropdown-menu dropdown-menu-end dropdown-menu-arrow messages">
              ...
              <li className="message-item">
                <a href="#">
                  <img src={messageItem1} alt="" className="rounded-circle" />
                  <div>
                    <h4>Maria Hudson</h4>
                    <p>
              ...
              <li className="message-item">
                <a href="#">
                  <img src={messageItem2} alt="" className="rounded-circle" />
                  <div>
                    <h4>Anna Nelson</h4>
                    <p>
                      Velit asperiores et ducimus soluta repudiandae labore
              ...
              <li className="message-item">
                <a href="#">
                  <img src={messageItem3} alt="" className="rounded-circle" />
                  <div>
                    <h4>David Muldon</h4>
                    <p>
                      Velit asperiores et ducimus soluta repudiandae labore
